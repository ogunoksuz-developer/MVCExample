...
namespace WebApplication2.Controllers
{
    public class KullaniciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ad,Sifre,Role")] Kullanicilar kullanicilar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ad,Sifre,Role")] Kullanicilar kullanicilar)
        {
            if (ModelState.IsValid)
            {
